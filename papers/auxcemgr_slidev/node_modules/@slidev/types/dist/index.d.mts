...
interface Headmatter extends HeadmatterConfig, Omit<Frontmatter, 'title' | 'transition'> {
  /**
...
interface CodeblockTransformContext {
  /**
...
type CodeblockTransformer = (ctx: CodeblockTransformContext) => Awaitable<string | undefined | null>;
declare const defineMarkdownTransformer: (fn: MarkdownTransformer) => MarkdownTransformer;
declare const defineCodeblockTransformer: (fn: CodeblockTransformer) => CodeblockTransformer;
//#endregion
...
type MermaidRenderFn = (code: string, options: Record<string, any>) => Awaitable<string>;
type MermaidRendererSetup = () => Awaitable<MermaidRenderFn | void>;
...
declare const defineMermaidRendererSetup: (fn: MermaidRendererSetup) => MermaidRendererSetup;
...
//#endregion
export { AppContext, AppSetup, BuildArgs, BuiltinSlideTransition, ClicksContext, ClicksElement, ClicksInfo, CodeRunner, CodeRunnerContext, CodeRunnerOutput, CodeRunnerOutputDom, CodeRunnerOutputError, CodeRunnerOutputHtml, CodeRunnerOutputText, CodeRunnerOutputTextArray, CodeRunnerOutputs, CodeRunnerProviders, CodeRunnersSetup, CodeblockTransformContext, CodeblockTransformer, CommonArgs, ContextMenuItem, ContextMenuSetup, DrawingsOptions, ExportArgs, FontOptions, Frontmatter, FrontmatterStyle, Headmatter, HeadmatterConfig, KatexSetup, MarkdownTransformContext, MarkdownTransformer, MermaidRenderFn, MermaidRendererSetup, MermaidSetup, MonacoSetup, MonacoSetupReturn, NavOperations, NormalizedAtValue, NormalizedRangeClickValue, NormalizedSingleClickValue, PreparserExtensionLoader, PreparserSetup, RawAtValue, RawRangeAtValue, RawSingleAtValue, RenderContext, ResolvedDrawingsOptions, ResolvedExportOptions, ResolvedFontOptions, ResolvedSlidevConfigSub, ResolvedSlidevOptions, ResolvedSlidevUtils, RootSetup, RootsInfo, RoutesSetup, SeoMeta, ShikiContext, ShikiSetup, ShikiSetupReturn, ShortcutOptions, ShortcutsSetup, SlideInfo, SlideInfoBase, SlidePatch, SlideRoute, SlidevConfig, SlidevData, SlidevDetectedFeatures, SlidevEntryOptions, SlidevMarkdown, SlidevPluginOptions, SlidevPreparserExtension, SlidevServerOptions, SlidevThemeConfig, SlidevThemeMeta, SourceSlideInfo, TocItem, TransformersSetup, TransformersSetupReturn, TransitionGroupProps, TransitionOptions, UnoSetup, VitePluginsSetup, defineAppSetup, defineCodeRunnersSetup, defineCodeblockTransformer, defineContextMenuSetup, defineKatexSetup, defineMarkdownTransformer, defineMermaidRendererSetup, defineMermaidSetup, defineMonacoSetup, definePreparserSetup, defineRootSetup, defineRoutesSetup, defineShikiSetup, defineShortcutsSetup, defineTransformersSetup, defineUnoSetup, defineVitePluginsSetup };